function Personal(){
    return(
        ...
        <section className='lg:ml-[100px]'>
            ...
            <div className='flex '>
            <img className='w-[50px] cursor-pointer lg:w-[100px]' src="public/Github.png" alt="Github Logo" />
            <img className='w-[50px] cursor-pointer lg:w-[100px]' src="public/Linkedin.png" alt="Linkedin Logo" />
            </div>
        </section>
        </>
    )
